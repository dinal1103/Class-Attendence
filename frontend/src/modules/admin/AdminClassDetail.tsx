...
import { Loader2, BookOpen, Users, ArrowLeft, CheckCircle, XCircle, CalendarCheck, Clock } from 'lucide-react';
                ...
                <Card>
                    <CardContent className="p-4 flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-lg font-bold text-surface-900">{completedSessions.length}</p>
                        </div>
                    </CardContent>
                </Card>
                <Card>
                    <CardContent className="p-4 flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm font-medium text-surface-900 truncate">{cls.faculty_id?.name || 'Unassigned'}</p>
                        </div>
                    </CardContent>
                </Card>
            </div>
            ...
            <Card>
                ...
                <CardContent>
                    {completedSessions.length === 0 ? (
                        <EmptyState icon="calendar" title="No sessions" description="No completed attendance sessions yet." compact />
                    ) : (
